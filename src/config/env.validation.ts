...
export const envValidationSchema = Joi.object({
  ...
  GLOBAL_RATE_LIMIT_PER_MINUTE: Joi.number().default(120),
  AUTH_RATE_LIMIT_PER_MINUTE: Joi.number().default(5),
  OTP_RATE_LIMIT_PER_10_MINUTES: Joi.number().default(3),
  ADMIN_PANEL_ORIGIN: Joi.string().required(),
  VENDOR_PANEL_ORIGIN: Joi.string().required(),
  CORS_ORIGINS: Joi.string().allow('', null),
  SUPER_ADMIN_EMAIL: Joi.string().email({ tlds: { allow: false } }).allow('', null).optional(),
  SUPER_ADMIN_PASSWORD: Joi.string().allow('', null).optional(),
});
