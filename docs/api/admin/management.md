...
Filtered admin management endpoints from `admin.md`.
...
```bash
curl -X PATCH "http://localhost:3000/api/v1/admin/customers/customer_user_uuid" \
  -H "Authorization: Bearer $ADMIN_ACCESS_TOKEN" \
  -H "Accept: application/json" \
  -H "Content-Type: application/json" \
  -d '{"status":"ACTIVE","name":"Deb Updated"}'
```
...
```bash
curl -X PATCH "http://localhost:3000/api/v1/admin/pets/pet_uuid" \
  -H "Authorization: Bearer $ADMIN_ACCESS_TOKEN" \
  -H "Accept: application/json" \
  -H "Content-Type: application/json" \
  -d '{"name":"Bruno Updated","breed":"Golden Retriever","isActive":true}'
```
...
```bash
curl -X DELETE "http://localhost:3000/api/v1/admin/pets/pet_uuid" \
  -H "Authorization: Bearer $ADMIN_ACCESS_TOKEN" \
  -H "Accept: application/json"
```
...
| Method | `GET` |
| Full URL | `http://localhost:3000/api/v1/admin/reports/revenue?from=2026-07-01&to=2026-07-05` |
| Auth | Bearer $ADMIN_ACCESS_TOKEN |
| Roles | ADMIN or SUPER_ADMIN |
...
```bash
curl -X GET "http://localhost:3000/api/v1/admin/reports/revenue?from=2026-07-01&to=2026-07-05" \
  -H "Authorization: Bearer $ADMIN_ACCESS_TOKEN" \
  -H "Accept: application/json"
```
...
| Method | `GET` |
| Full URL | `http://localhost:3000/api/v1/admin/reports/products?from=2026-07-01&to=2026-07-05` |
| Auth | Bearer $ADMIN_ACCESS_TOKEN |
| Roles | ADMIN or SUPER_ADMIN |
...
```bash
curl -X GET "http://localhost:3000/api/v1/admin/reports/products?from=2026-07-01&to=2026-07-05" \
  -H "Authorization: Bearer $ADMIN_ACCESS_TOKEN" \
  -H "Accept: application/json"
```
...
| Field | Value |
| --- | --- |
| API name | Audit Log Detail |
| Method | `GET` |
| Full URL | `http://localhost:3000/api/v1/admin/audit-logs/audit_log_uuid` |
| Auth | Bearer $ADMIN_ACCESS_TOKEN |
| Roles | ADMIN or SUPER_ADMIN |
...
```bash
curl -X GET "http://localhost:3000/api/v1/admin/audit-logs/audit_log_uuid" \
  -H "Authorization: Bearer $ADMIN_ACCESS_TOKEN" \
  -H "Accept: application/json"
```
